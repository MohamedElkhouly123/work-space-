...
public class SharedOfficesFragment extends BaSeFragment {
    NavController navController ;

    @BindView(R.id.fragment_shared_office_recycler_view)
    RecyclerView fragmentServicesRv;
    private List<String> list= new ArrayList<>() ;
//    private ViewModelGetLists viewModel;
//    @BindView(R.id.fragment_shared_office_sr_refresh)
...
//    private NavController navController;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =inflater.inflate(R.layout.fragment_shared_offices, container, false);
    ...
    @OnClick({R.id.favoret_bt,R.id.fragment_shared_office_search_et})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.favoret_bt:
                navController.navigate(R.id.action_share_office_fragment_to_favoret);

                break;

            case R.id.fragment_shared_office_search_et:
                Bundle bundle = new Bundle();

                bundle.putString("filterPage","SharedOffice");
...
//                        }
        ...
        homeAdapter = new HomeAdapter(getContext(), getActivity(),list ,navController,"sharedOffice");
