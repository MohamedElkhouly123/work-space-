...
public class WorkSpaceFragment extends BaSeFragment {
    ...
    @BindView(R.id.fragment_work_space_recycler_view)
    RecyclerView fragmentServicesRv;
    private List<String> list= new ArrayList<>() ;
//    private ViewModelGetLists viewModel;
//    @BindView(R.id.fragment_work_space_sr_refresh)
...
//    private NavController navController;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =inflater.inflate(R.layout.fragment_work_space, container, false);
...
initRS();
    ...
    @OnClick({R.id.favoret_bt,R.id.fragment_work_space_search_et})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.favoret_bt:
                navController.navigate(R.id.action_work_space_fragment_to_favoret);

                break;
            case R.id.fragment_work_space_search_et:
                Bundle bundle = new Bundle();

                bundle.putString("filterPage","WorkSpace");
...
//                        }
        ...
        homeAdapter = new HomeAdapter(getContext(), getActivity(),list ,navController,"workerSpace");
